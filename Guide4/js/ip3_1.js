...
function excel(Location, i){ //엑셀이 입력될 타겟, 기획전타입번호
	...
	switch (i){
		//입점
		case '0': mall='cjmall';outPut='_cj_pick';wSize='858';break;
		case '1': mall='hmall';outPut='_h_pick';wSize='778';break; 
		case '2': mall='gsshop';outPut='_gs_pick';wSize='778';break;
		case '3': mall='lottei';outPut='_lottei_pick';wSize='778';break;
		case '4': mall='naver';outPut='_naver_pick';wSize='758';break; 
		case '5': mall='11st';outPut='_e_pick';wSize='858';break; //11번가
		case '6': mall='auction';outPut='_a_pick';wSize='858';break; //옥션
		case '7': mall='gmarket';outPut='_g_pick';wSize='828';break; //G마켓
		case '8': mall='g9';outPut='_g9_pick';wSize='778';break; 
		case '9': mall='tmon';outPut='_tmon_pick';wSize='768';break; //티몬
			...
			if(e>=13){
				...
				if(j==60){
					...
					if (ex[e][35]=='.' || ex[e][3].value == undefined || ex[e][j].value == null || ex[e][j].value == false){
						tSecC=''+
								'<p id="t'+cntT+'" style="margin: 0px; padding: 0px;"><img src="http://mall.hyundailivart.co.kr/UserFiles/Image/03_ipjum/'+mall+'/'+dayCode+'_pick/guide/t'+cntT+'.jpg" style="margin: 0px auto; border: 0px currentColor; border-image: none; display: block;" border="0"></p>'+
								'<p style="margin: 0px; padding: 0px;"><img src="http://mall.hyundailivart.co.kr/UserFiles/Image/03_ipjum/'+mall+'/'+dayCode+'_pick/b'+cntT+'.jpg" style="margin: 0px auto; border: 0px currentColor; border-image: none; display: block;" border="0"></p>'+
								'';
					}
					else {
						tSecC=''+
								'<p id="t'+cntT+'" style="margin: 0px; padding: 0px;"><img src="http://mall.hyundailivart.co.kr/UserFiles/Image/03_ipjum/'+mall+'/'+dayCode+'_pick/guide/t'+cntT+'.jpg" style="margin: 0px auto; border: 0px currentColor; border-image: none; display: block;" border="0"></p>'+
								'<p style="margin: 0px; padding: 0px;"><img src="'+ex[e][35]+'" style="margin: 0px auto; border: 0px currentColor; border-image: none; display: block;" border="0"></p>'+
								'';
					}
					...
					oSecC=oSecC+
								''+
								'<p style="margin: 0px; padding: 0px;"><a href="#t'+cntC+'"><img src="http://mall.hyundailivart.co.kr/UserFiles/Image/03_ipjum/'+mall+'/'+dayCode+'_pick/guide/o'+cntC+'.jpg" style="margin: 0px auto; border: 0px currentColor; border-image: none; display: block;" border="0"/></a></p>'+ // usemap="#lvtMap'+cntC+'"
								''+
								'';
	...
	sum =   ''+
			scp+ //Css, Font 호출값
			'<div class="oWrap" style="width:'+wSize+'px;margin-bottom:50px;">'+
			oBox+
			emt+
			'</div>'+
			'<!-- 타이틀 영역 -->'+
			...
			'	<p style="margin: 0px; padding: 0px;"><img src="http://mall.hyundailivart.co.kr/UserFiles/Image/03_ipjum/'+mall+'/'+dayCode+'_pick/a01.jpg" style="display:block;margin:0 auto;" border="0"/></p>'+ 
			oBoxC+
			tBoxC+
