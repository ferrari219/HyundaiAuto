...
window.onload = function () {
	...
	//alert(year+mon+day);
	//return year+mon+day;
	document.frm.today.value = '170331_check1';
...
function excel(Location, i) {
			...
			if (e >= 13) {
				...
				if (j == 59) {
					...
					if (ex[e][22] == '') {
						...
						pcn1 = '				<em>' + addComma(ex[e][22]) + '<span>원</span></em>';
					}
					...
					if (ex[e][24] == '') {
						...
						pcn2 = '				<em>' + addComma(ex[e][24]) + '<span>원</span></em>';
					}
					...
					if (ex[e][26] == '') {
						...
						pcn3 = '				<em>' + addComma(ex[e][26]) + '<span>원</span></em>';
					}
					...
					sNum = '' + '<!-- 숫자영역 sNum -->' + '<div class="sNum ' + ex[e][37] + '">' + '	<table class="typeA">' + '		<tr>' + '			<td>' + '				<span>' + ex[e][9] + '</span>' + '				<strong>' + ex[e][10] + '</strong>' + '			</td>' + '		</tr>' + '	</table>' + '</div>' + '';
					ttl = '' + '<!-- 타이틀영역 -->' + '<div class="ttl ' + ex[e][38] + '">' + '	<table class="typeA">' + '		<tr>' + '			<td>' + ee + tt + ss + '			</td>' + '		</tr>' + '	</table>' + '</div>' + '';
					...
					pic = '' + '<!-- 사진영역 -->' + '<div class="pic ' + ex[e][36] + '">' + '	<p><img src="' + picResize(ex[e][34]) + '" alt="" /></p>' + '</div>' + '';
					pc = '' + '<!-- 가격영역 -->' + '<div class="prc">' + '	<table class="typeA">' + '		<tr>' + '			<td>' + '				<!-- 가격영역 -->' + pc1 + pc2 + pc3 + etc + '			</td>' + '		</tr>' + '	</table>' + '</div>' + '';

					/* 타이틀 값 영역 할당 */
					if (ex[e][9] == '@' || ex[e][10] == '@') {
						sNum = '' + '<!-- 숫자영역 sNum -->' + '<div class="sNum emt ' + ex[e][37] + '">' + '</div>' + '';
						...
						stNum = '' + '<!-- 넘버 영역 -->' + '<div class="sNum ' + ex[e][38] + '">' + '	<table class="typeA">' + '		<tr>' + '			<td>' + '				<em>' + ex[e][9] + '</em><span>' + ex[e][10] + '</span>' + '			</td>' + '		</tr>' + '	</table>' + '</div>' + '';
					}
					tTtl = '' + '<div class="ttl ' + ex[e][38] + '">' + '	<table class="typeA">' + '		<tr>' + '			<td>' + ee + tt + ss + '			</td>' + '		</tr>' + '	</table>' + '</div>' + '';
					if (ex[e][22] == '' && ex[e][24] == '' && ex[e][26] == '') {
						pc = '';
						tpc = '';
					} else {
						tpc = '' + '<div class="prc ' + ex[e][20] + ' ' + ex[e][38] + '">' + '	<table class="typeA">' + '		<tr>' + '			<td>' + '				<!-- 가격영역 -->' + pc1 + pc2 + pc3 + etc + '			</td>' + '		</tr>' + '	</table>' + '</div>' + '';
					}
				} //값 할당
				/* 조립 */
				if (j == 60) {
					...
					scp = '<link rel="stylesheet" type="text/css" href="css/' + css + '_ip.css"/> '; //추가 스크립트값

					//alert(ex[e][2]);
					switch (String(ex[e][2])) {
						case 'gs0':
							scp = scp + '<link rel="stylesheet" type="text/css" href="css/NanumBarunGothic.css"/>' + '<link rel="stylesheet" type="text/css" href="css/whitney-Bold.css"/>' + '<link rel="stylesheet" type="text/css" href="css/OldSansBlack.css"/>'; //추가 스크립트값
						...
						case 'gs1':
							...
							break;
						case 'l0':
							scp = scp + '<link href="https://cdn.rawgit.com/theeluwin/NotoSansKR-Hestia/master/stylesheets/NotoSansKR-Hestia.css" rel="stylesheet" type="text/css"/>' + ''; //추가 스크립트값
							...
							break;
						case 'a0':
							scp = scp + '<link rel="stylesheet" type="text/css" href="css/NanumBarunGothic.css"/>' + '<link rel="stylesheet" type="text/css" href="css/OldSansBlack.css"/>'; //추가 스크립트값
							part1 = '' + '<div class="part1">' + sNum + ttl + '</div>' + '';
						...
						case 'd1':
							scp = scp + '<link rel="stylesheet" type="text/css" href="css/NanumBarunGothic.css"/>' + '<link rel="stylesheet" type="text/css" href="css/OldSansBlack.css"/>'; //추가 스크립트값
							part1 = '' + '<div class="part1">' + '	<table class="typeA">' + '		<tr>' + '			<td>' + sNum + ttl + pc + '			</td>' + '		</tr>' + '	</table>' + '</div>' + '';
							part2 = '' + '<div class="part2">' + pic + dc + '</div>' + '';
							part3 = '' + '<div class="part3">' + '</div>' + '';
							tpart1 = '' + '<div class="part1">' + stNum + '</div>' + '';
							tpart2 = '' + '<div class="part2">' + tTtl + '</div>' + '';
							tpart3 = '' + '<div class="part3">' + tpc + '</div>' + '';
							break;
					...
					oSec =
						oSec +
						'<div class="oSec">' +
						//'	<a href="'+ex[e][35]+'" onclick="window.open(\'http://mall.hyundailivart.co.kr/UserFiles/Image/00_product/03_ipjum/popup.html?code='+ex[e][50]+'&nme='+ex[e][15]+'\', \'_blank\', \'width=860, height=900,scrollbars=yes,left=20,top=0\');return false;">'+
						'	<a href="#t' +
						ex[e][10] +
						'">' +
						/* ex[e][3] */
					...
					tSec =
						...
						tpart3 +
						'</div>' +
						//'<p style="clear:both;margin:0;padding:0;"><img src="http://mall.hyundailivart.co.kr/UserFiles/Image/00_product/03_ipjum/'+ex[e][50]+'.jpg" style="display:block;margin:0 auto;" border="0" alt=""/></p>'+ /* onerror="this.src=\'http://mall.hyundailivart.co.kr/UserFiles/Image/03_ipjum/common/perr.jpg\'" */
						'';
					...
					if (ex[e][35] == '.' || ex[e][3].value == undefined || ex[e][j].value == null || ex[e][j].value == false) {
						tSecC =
							'' +
							'<p id="t' +
							cntT +
							'" style="margin: 0px; padding: 0px;"><img src="http://mall.hyundailivart.co.kr/UserFiles/Image/03_ipjum/' +
							mall +
							'/' +
							dayCode +
							'_pick/guide/t' +
						...
						tSecC =
							...
							cntT +
							'.jpg" style="margin: 0px auto; border: 0px currentColor; border-image: none; display: block;" border="0"></p>' +
							'<p style="margin: 0px; padding: 0px;"><img src="' +
							ex[e][35] +
							'" style="margin: 0px auto; border: 0px currentColor; border-image: none; display: block;" border="0"></p>' +
							'';
					}

					oBox = oBox + '<!-- 옵션리스트 영역 -->' + '<div class="oBox ' + ex[13][4] + '">' + oSec + '</div>' + '';
					oSec = ''; //구분값 변수 초기화
					cnt = cnt + 1; //카운트
					//자릿수 변형
					...
					oSecC =
						oSecC +
						'' +
						'<p style="margin: 0px; padding: 0px;"><a href="#t' +
						cntC +
						'"><img src="http://mall.hyundailivart.co.kr/UserFiles/Image/03_ipjum/' +
						mall +
						'/' +
						dayCode +
						'_pick/guide/o' +
						cntC +
						'.jpg" style="margin: 0px auto; border: 0px currentColor; border-image: none; display: block;" border="0"/></a></p>' + // usemap="#lvtMap'+cntC+'"
						'' +
						'';
					...
					/* if(ex[13][4]=='s2' && e==oRange.Rows.count && e%2==1){
						...
						emtC='<p style="margin: 0px; padding: 0px;"><img src="http://mall.hyundailivart.co.kr/UserFiles/Image/03_ipjum/'+mall+'/'+dayCode+'_pick/guide/o'+cntC+'.jpg" usemap="#lvtMap'+cntC+'" style="margin: 0px auto; border: 0px currentColor; border-image: none; display: block;" border="0">'+
	...
	sum =
		...
		'/' +
		dayCode +
		'_pick/a01.jpg" style="display:block;margin:0 auto;" border="0"/></p>' +
		oBoxC +
		tBoxC +
