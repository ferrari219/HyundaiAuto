...
//------------------------- 엑셀 영역 --------------------------------//
//엑셀 불러오기
function excel(Location, i, c) {
	//엑셀이 입력될 타겟, 기획전타입번호, 코딩여부
	...
	function making(judge, tType1, txt1, tType2, txt2, tType3, txt3, tType4, txt4, tType5, txt5, tType6, txt6, tType7, txt7, bg, jpg, mp4, pic1, mod) {
		...
		// }
		// else{
		tType(String(tType1), String(txt1), judge);
		tType(String(tType2), String(txt2), judge);
		tType(String(tType3), String(txt3), judge);
		tType(String(tType4), String(txt4), judge);
		tType(String(tType5), String(txt5), judge);
		tType(String(tType6), String(txt6), judge);
		...
		switch (String(judge)) {
			case 's1-1':
			case 's2-1':
				Temp = '' + '<div class="' + judge + ' ' + bg + '">' + '	<div class="text">' + h3 + '		<dl>' + dt + dd + '		</dl>' + sup + '	</div>' + pic + '</div>' + '';
				tCnt = 7;
				break;
			case 's1-2':
			case 's2-2':
				Temp = '' + '<div class="' + judge + ' ' + bg + '">' + pic + '	<div class="text">' + h3 + '		<dl>' + dt + dd + '		</dl>' + sup + '	</div>' + '</div>' + '';
				tCnt = 7;
				break;
			case 's1-3':
				Temp = '' + '<div class="' + judge + ' ' + bg + '">' + pic + '	<div class="text">' + h3 + '		<dl>' + dt + dd + '		</dl>' + sup + '	</div>' + '</div>' + '';
				...
				switch (String(ex[e][23])) {
					...
					case '옵션':
						if (ex[e][2] == undefined || ex[e][2] == '') {
							...
							specAlt = specAlt + ex[e][3] + '/' + '';
						}
						break;
					case '구성': //구성 cfg
						cfg = cfg + '<dl class="s1">' + '	<dt>구성</dt>' + '	<dd>' + ex[e][2] + '		<span>' + ex[e][8] + '</span>' + '	</dd>' + '</dl>';
						'';
						break;
					case '규격': //규격 std
						// alert(ex[e][0]);
						switch (
							String(ex[e][0]) //레이아웃 결정
						) {
							case 's1':
								std = std + '<div class="s1">' + '	<dl>' + '		<dt>규격</dt>' + '		<dd>' + ex[e][1] + ' ' + ex[e][2] + ' ' + ex[e][3] + ' ' + ex[e][4] + ' ' + ex[e][5] + ' ' + ex[e][6] + ' ' + ex[e][7] + ' mm</dd>' + '	</dl>' + '</div>' + '';
								specAlt = specAlt + ex[e][1] + ': ' + ex[e][2] + ' ' + ex[e][3] + ' ' + ex[e][4] + ' ' + ex[e][5] + ' ' + ex[e][6] + ' ' + ex[e][7] + ' mm/' + '';
								break;
							case 's2-1':
								for (k = 0; k < 2; k++) {
									//소제목 더하기
								...
								stdRow = '';
								specAlt = specAlt + ex[e][4] + ':' + ex[e][3] + 'x' + ex[e][5] + 'x' + ex[e][7] + 'mm/' + '';
								e = e + 1;
								break;
							case 's3-1':
								for (k = 0; k < 3; k++) {
					...
					case '마감소재': //마감소재 clsm
						if (String(ex[e][1]) === String(ex[e - 1][1])) {
							//침대 === 침대
							//alert('ex['+e+'] = em 비워');
							if (String(ex[e][23]) === String(ex[e - 1][23])) {
								//마감소재 === 마감소재
								clsmTit = '';
								clsmCol = '';
							}
							...
							clsmTit = '' + '<dd>' + '	<em class="icon ' + cateICO + '">' + ex[e][1] + '</em>' + '';
							//alert('ex['+e+'] = ul열어');
							clsmCol = '' + '	<ul>' + clsmCol + '';
						}
						...
						clsmCol = clsmCol + '		<li>' + clsmColS + '			<span>' + ex[e][3] + ' ' + ex[e][4] + ' ' + ex[e][5] + ' ' + ex[e][6] + ' ' + ex[e][7] + '</span>' + '		</li>' + '';
						...
						clsmCol = '';
						specAlt = specAlt + ex[e][4] + ':' + ex[e][3] + ' ' + ex[e][5] + ' ' + ex[e][7] + '/' + '';
						break;
					case '원산지': //원산지 org
						org = org + '<p>' + ex[e][2] + ' ' + ex[e][3] + ' ' + ex[e][4] + ' ' + ex[e][5] + ' ' + ex[e][6] + ' ' + ex[e][7] + '</p>' + '';
						specAlt = specAlt + ex[e][2] + ' ' + ex[e][3] + ' ' + ex[e][4] + ' ' + ex[e][5] + ' ' + ex[e][6] + ' ' + ex[e][7] + '/' + '';
						break;
					case '제조원': //제조원 mfs
						mfs =
							mfs +
					...
					case '사이즈': //사이즈 sz
						...
						break;
					case '인증': //인증 cert
						cert = cert + '<dl class="s1">' + '	<dt>인증</dt>' + '	<dd>' + ex[e][2] + '</dd>' + '</dl>';
						'';
						break;
					case '주의': //주의 ctn
						var ctnTemp = '';
						if (ex[e][2] == '' || ex[e][2] == '-') {
							...
							ctnTemp =
								...
								'/' +
								outPut +
								'/01_cmn/cau02.jpg" alt="벽고정필수 주의사항" style="' +
								imgAtr +
								'"/>' +
			...
			for (x = 0; x <= 1; x++) {
				for (y = 0; y <= 9; y++) {
					if (ex[e + x][y] !== '') {
						...
						//한자리수 처리
						if (ex[e + x][y].length === 1) {
							ex[e + x][y] = '0' + ex[e + x][y];
						} else if (ex[e + x][y].length === 2 && Left(ex[e + x][y], 1) === 'g') {
							ex[e + x][y] = 'g0' + Right(ex[e + x][y], 1);
						} else if (ex[e + x][y].length === 2 && Left(ex[e + x][y], 1) === 'r') {
							ex[e + x][y] = 'r0' + Right(ex[e + x][y], 1);
						}
						...
						if (Left(ex[e + x][y], 1) === 'g') {
							ex[e + x][y] =
								'' + '			<img src="' + loc2 + onOff + '/' + outPut + '/' + sCode + '/group/' + k + '/' + Right(ex[e + x][y], 2) + '.gif' + '" ' + hvr + ' style="' + imgAtr + '" alt="' + exAlt[parseInt(temp1, 10)][parseInt(temp2, 10)] + '"/>' + '';
							hvr = '';
							...
							hvr =
								...
								'.jpg"';
							ex[e + x][y] =
								'' + '			<img src="' + loc2 + onOff + '/' + outPut + '/' + sCode + '/group/' + k + '/' + Right(ex[e + x][y], 2) + '.jpg' + '" ' + hvr + ' style="' + imgAtr + '" alt="' + exAlt[parseInt(temp1, 10)][parseInt(temp2, 10)] + '"/>' + '';
							...
							ex[e + x][y] = '' + '			<img src="' + loc2 + onOff + '/' + outPut + '/' + sCode + '/group/' + k + '/' + ex[e + x][y] + '.jpg' + '" ' + hvr + ' style="' + imgAtr + '" alt="' + exAlt[parseInt(temp1, 10)][parseInt(temp2, 10)] + '"/>' + '';
						}
