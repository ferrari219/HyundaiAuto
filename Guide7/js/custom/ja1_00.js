	...
	if(dayCode==''){
		...
		for(var k=12;k<=oRange.Rows.count;k++){
			...
			if(Type=='t0'){//타이틀
				...
				if(secLnk1=='.' || secLnk1.value == undefined || secLnk1.value == null || secLnk1.value == false){	secLnk1='<img src="http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/'+dayCode+'/'+secSNme1+'.'+secFne1+'" onerror="this.src=\'http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/slice/box1.jpg\';"  alt="'+secNme1+'"/>';	}
				else{secLnk1='<a href="'+secLnk1+'"><img src="http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/'+dayCode+'/'+secSNme1+'.'+secFne1+'" onerror="this.src=\'http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/slice/box1.jpg\';"  alt="'+secNme1+'"/></a>';}
				...
				if(secFne1=='.' || secFne1.value == undefined || secFne1.value == null || secFne1.value == false){	secFne1='jpg';	}
				secLnk1=oRange.Cells(k,35);//URL
				if(secLnk1=='.' || secLnk1.value == undefined || secLnk1.value == null || secLnk1.value == false){	secLnk1='<img src="http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/'+dayCode+'/'+secSNme1+'.'+secFne1+'" onerror="this.src=\'http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/slice/box21.jpg\';"  alt="'+secNme1+'"/>';	}
				else{secLnk1='<a href="'+secLnk1+'"><img src="http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/'+dayCode+'/'+secSNme1+'.'+secFne1+'" onerror="this.src=\'http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/slice/box21.jpg\';"  alt="'+secNme1+'"/></a>';}
				...
				if(secLnk2=='.' || secLnk2.value == undefined || secLnk2.value == null || secLnk2.value == false){	secLnk2='<img src="http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/'+dayCode+'/'+secSNme2+'.'+secFne2+'" onerror="this.src=\'http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/slice/box22.jpg\';"  alt="'+secNme2+'"/>';	}
				else{secLnk2='<a href="'+secLnk2+'"><img src="http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/'+dayCode+'/'+secSNme2+'.'+secFne2+'" onerror="this.src=\'http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/slice/box22.jpg\';"  alt="'+secNme2+'"/></a>';}
				...
				if(secFne1=='.' || secFne1.value == undefined || secFne1.value == null || secFne1.value == false){	secFne1='jpg';	}
				secLnk1=oRange.Cells(k,35);//URL
				if(secLnk1=='.' || secLnk1.value == undefined || secLnk1.value == null || secLnk1.value == false){	secLnk1='<img src="http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/'+dayCode+'/'+secSNme1+'.'+secFne1+'" onerror="this.src=\'http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/slice/box31.jpg\';"  alt="'+secNme1+'"/>';	}
				else{secLnk1='<a href="'+secLnk1+'"><img src="http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/'+dayCode+'/'+secSNme1+'.'+secFne1+'" onerror="this.src=\'http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/slice/box31.jpg\';"  alt="'+secNme1+'"/></a>';}
				...
				if(secFne2=='.' || secFne2.value == undefined || secFne2.value == null || secFne2.value == false){	secFne2='jpg';	}
				secLnk2=oRange.Cells(k,35);//URL
				if(secLnk2=='.' || secLnk2.value == undefined || secLnk2.value == null || secLnk2.value == false){	secLnk2='<img src="http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/'+dayCode+'/'+secSNme2+'.'+secFne2+'" onerror="this.src=\'http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/slice/box32.jpg\';"  alt="'+secNme2+'"/>';	}
				else{secLnk2='<a href="'+secLnk2+'"><img src="http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/'+dayCode+'/'+secSNme2+'.'+secFne2+'" onerror="this.src=\'http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/slice/box32.jpg\';"  alt="'+secNme2+'"/></a>';}
				...
				if(secLnk3=='.' || secLnk3.value == undefined || secLnk3.value == null || secLnk3.value == false){	secLnk3='<img src="http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/'+dayCode+'/'+secSNme3+'.'+secFne3+'" onerror="this.src=\'http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/slice/box33.jpg\';"  alt="'+secNme3+'"/>';	}
				else{secLnk3='<a href="'+secLnk3+'"><img src="http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/'+dayCode+'/'+secSNme3+'.'+secFne3+'" onerror="this.src=\'http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/slice/box33.jpg\';"  alt="'+secNme3+'"/></a>';}
				...
				if(secFne1=='.' || secFne1.value == undefined || secFne1.value == null || secFne1.value == false){	secFne1='jpg';	}
				secLnk1=oRange.Cells(k,35);//URL
				if(secLnk1=='.' || secLnk1.value == undefined || secLnk1.value == null || secLnk1.value == false){	secLnk1='<img src="http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/'+dayCode+'/'+secSNme1+'.'+secFne1+'" onerror="this.src=\'http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/slice/box41.jpg\';"  alt="'+secNme1+'"/>';	}
				else{secLnk1='<a href="'+secLnk1+'"><img src="http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/'+dayCode+'/'+secSNme1+'.'+secFne1+'" onerror="this.src=\'http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/slice/box41.jpg\';"  alt="'+secNme1+'"/></a>';}
				...
				if(secFne2=='.' || secFne2.value == undefined || secFne2.value == null || secFne2.value == false){	secFne2='jpg';	}
				secLnk2=oRange.Cells(k,35);//URL
				if(secLnk2=='.' || secLnk2.value == undefined || secLnk2.value == null || secLnk2.value == false){	secLnk2='<img src="http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/'+dayCode+'/'+secSNme2+'.'+secFne2+'" onerror="this.src=\'http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/slice/box42.jpg\';"  alt="'+secNme2+'"/>';	}
				else{secLnk2='<a href="'+secLnk2+'"><img src="http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/'+dayCode+'/'+secSNme2+'.'+secFne2+'" onerror="this.src=\'http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/slice/box42.jpg\';"  alt="'+secNme2+'"/></a>';}
				...
				if(secFne3=='.' || secFne3.value == undefined || secFne3.value == null || secFne3.value == false){	secFne3='jpg';	}
				secLnk3=oRange.Cells(k,35);//URL
				if(secLnk3=='.' || secLnk3.value == undefined || secLnk3.value == null || secLnk3.value == false){	secLnk3='<img src="http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/'+dayCode+'/'+secSNme3+'.'+secFne3+'" onerror="this.src=\'http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/slice/box43.jpg\';"  alt="'+secNme3+'"/>';	}
				else{secLnk3='<a href="'+secLnk3+'"><img src="http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/'+dayCode+'/'+secSNme3+'.'+secFne3+'" onerror="this.src=\'http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/slice/box43.jpg\';"  alt="'+secNme3+'"/></a>';}
				...
				if(secLnk4=='.' || secLnk4.value == undefined || secLnk4.value == null || secLnk4.value == false){	secLnk4='<img src="http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/'+dayCode+'/'+secSNme4+'.'+secFne4+'" onerror="this.src=\'http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/slice/box44.jpg\';"  alt="'+secNme4+'"/>';	}
				else{secLnk4='<a href="'+secLnk4+'"><img src="http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/'+dayCode+'/'+secSNme4+'.'+secFne4+'" onerror="this.src=\'http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/slice/box44.jpg\';"  alt="'+secNme4+'"/></a>';}
				...
				if(secFne1=='.' || secFne1.value == undefined || secFne1.value == null || secFne1.value == false){	secFne1='jpg';	}
				secLnk1=oRange.Cells(k,35);//URL
				if(secLnk1=='.' || secLnk1.value == undefined || secLnk1.value == null || secLnk1.value == false){	secLnk1='<img src="http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/'+dayCode+'/'+secSNme1+'.'+secFne1+'" onerror="this.src=\'http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/slice/box51.jpg\';"  alt="'+secNme1+'"/>';	}
				else{secLnk1='<a href="'+secLnk1+'"><img src="http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/'+dayCode+'/'+secSNme1+'.'+secFne1+'" onerror="this.src=\'http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/slice/box51.jpg\';"  alt="'+secNme1+'"/></a>';}
				...
				if(secFne2=='.' || secFne2.value == undefined || secFne2.value == null || secFne2.value == false){	secFne2='jpg';	}
				secLnk2=oRange.Cells(k,35);//URL
				if(secLnk2=='.' || secLnk2.value == undefined || secLnk2.value == null || secLnk2.value == false){	secLnk2='<img src="http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/'+dayCode+'/'+secSNme2+'.'+secFne2+'" onerror="this.src=\'http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/slice/box52.jpg\';"  alt="'+secNme2+'"/>';	}
				else{secLnk2='<a href="'+secLnk2+'"><img src="http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/'+dayCode+'/'+secSNme2+'.'+secFne2+'" onerror="this.src=\'http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/slice/box52.jpg\';"  alt="'+secNme2+'"/></a>';}
				...
				if(secFne3=='.' || secFne3.value == undefined || secFne3.value == null || secFne3.value == false){	secFne3='jpg';	}
				secLnk3=oRange.Cells(k,35);//URL
				if(secLnk3=='.' || secLnk3.value == undefined || secLnk3.value == null || secLnk3.value == false){	secLnk3='<img src="http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/'+dayCode+'/'+secSNme3+'.'+secFne3+'" onerror="this.src=\'http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/slice/box53.jpg\';"  alt="'+secNme3+'"/>';	}
				else{secLnk3='<a href="'+secLnk3+'"><img src="http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/'+dayCode+'/'+secSNme3+'.'+secFne3+'" onerror="this.src=\'http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/slice/box53.jpg\';"  alt="'+secNme3+'"/></a>';}
				...
				if(secFne4=='.' || secFne4.value == undefined || secFne4.value == null || secFne4.value == false){	secFne4='jpg';	}
				secLnk4=oRange.Cells(k,35);//URL
				if(secLnk4=='.' || secLnk4.value == undefined || secLnk4.value == null || secLnk4.value == false){	secLnk4='<img src="http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/'+dayCode+'/'+secSNme4+'.'+secFne4+'" onerror="this.src=\'http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/slice/box54.jpg\';"  alt="'+secNme4+'"/>';	}
				else{secLnk4='<a href="'+secLnk4+'"><img src="http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/'+dayCode+'/'+secSNme4+'.'+secFne4+'" onerror="this.src=\'http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/slice/box54.jpg\';"  alt="'+secNme4+'"/></a>';}
				...
				if(secLnk5=='.' || secLnk5.value == undefined || secLnk5.value == null || secLnk5.value == false){	secLnk5='<img src="http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/'+dayCode+'/'+secSNme5+'.'+secFne5+'" onerror="this.src=\'http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/slice/box55.jpg\';"  alt="'+secNme5+'"/>';	}
				else{secLnk5='<a href="'+secLnk5+'"><img src="http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/'+dayCode+'/'+secSNme5+'.'+secFne5+'" onerror="this.src=\'http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/slice/box55.jpg\';"  alt="'+secNme5+'"/></a>';}
				...
				if(secFne1=='.' || secFne1.value == undefined || secFne1.value == null || secFne1.value == false){	secFne1='jpg';	}
				secLnk1=oRange.Cells(k,35);//URL
				if(secLnk1=='.' || secLnk1.value == undefined || secLnk1.value == null || secLnk1.value == false){	secLnk1='<img src="http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/'+dayCode+'/'+secSNme1+'.'+secFne1+'" onerror="this.src=\'http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/slice/box61.jpg\';"  alt="'+secNme1+'"/>';	}
				else{secLnk1='<a href="'+secLnk1+'"><img src="http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/'+dayCode+'/'+secSNme1+'.'+secFne1+'" onerror="this.src=\'http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/slice/box61.jpg\';"  alt="'+secNme1+'"/></a>';}
				...
				if(secFne2=='.' || secFne2.value == undefined || secFne2.value == null || secFne2.value == false){	secFne2='jpg';	}
				secLnk2=oRange.Cells(k,35);//URL
				if(secLnk2=='.' || secLnk2.value == undefined || secLnk2.value == null || secLnk2.value == false){	secLnk2='<img src="http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/'+dayCode+'/'+secSNme2+'.'+secFne2+'" onerror="this.src=\'http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/slice/box62.jpg\';"  alt="'+secNme2+'"/>';	}
				else{secLnk2='<a href="'+secLnk2+'"><img src="http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/'+dayCode+'/'+secSNme2+'.'+secFne2+'" onerror="this.src=\'http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/slice/box62.jpg\';"  alt="'+secNme2+'"/></a>';}
				...
				if(secFne3=='.' || secFne3.value == undefined || secFne3.value == null || secFne3.value == false){	secFne3='jpg';	}
				secLnk3=oRange.Cells(k,35);//URL
				if(secLnk3=='.' || secLnk3.value == undefined || secLnk3.value == null || secLnk3.value == false){	secLnk3='<img src="http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/'+dayCode+'/'+secSNme3+'.'+secFne3+'" onerror="this.src=\'http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/slice/box63.jpg\';"  alt="'+secNme3+'"/>';	}
				else{secLnk3='<a href="'+secLnk3+'"><img src="http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/'+dayCode+'/'+secSNme3+'.'+secFne3+'" onerror="this.src=\'http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/slice/box63.jpg\';"  alt="'+secNme3+'"/></a>';}
				...
				if(secFne4=='.' || secFne4.value == undefined || secFne4.value == null || secFne4.value == false){	secFne4='jpg';	}
				secLnk4=oRange.Cells(k,35);//URL
				if(secLnk4=='.' || secLnk4.value == undefined || secLnk4.value == null || secLnk4.value == false){	secLnk4='<img src="http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/'+dayCode+'/'+secSNme4+'.'+secFne4+'" onerror="this.src=\'http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/slice/box64.jpg\';"  alt="'+secNme4+'"/>';	}
				else{secLnk4='<a href="'+secLnk4+'"><img src="http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/'+dayCode+'/'+secSNme4+'.'+secFne4+'" onerror="this.src=\'http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/slice/box64.jpg\';"  alt="'+secNme4+'"/></a>';}
				...
				if(secFne5=='.' || secFne5.value == undefined || secFne5.value == null || secFne5.value == false){	secFne5='jpg';	}
				secLnk5=oRange.Cells(k,35);//URL
				if(secLnk5=='.' || secLnk5.value == undefined || secLnk5.value == null || secLnk5.value == false){	secLnk5='<img src="http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/'+dayCode+'/'+secSNme5+'.'+secFne5+'" onerror="this.src=\'http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/slice/box65.jpg\';"  alt="'+secNme5+'"/>';	}
				else{secLnk5='<a href="'+secLnk5+'"><img src="http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/'+dayCode+'/'+secSNme5+'.'+secFne5+'" onerror="this.src=\'http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/slice/box65.jpg\';"  alt="'+secNme5+'"/></a>';}
				...
				if(secLnk6=='.' || secLnk6.value == undefined || secLnk6.value == null || secLnk6.value == false){	secLnk6='<img src="http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/'+dayCode+'/'+secSNme6+'.'+secFne6+'" onerror="this.src=\'http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/slice/box66.jpg\';"  alt="'+secNme6+'"/>';	}
				else{secLnk6='<a href="'+secLnk6+'"><img src="http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/'+dayCode+'/'+secSNme6+'.'+secFne6+'" onerror="this.src=\'http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/slice/box66.jpg\';"  alt="'+secNme6+'"/></a>';}
			...
			/* n1 */
			else if(Type=='n1'){//컨텐츠1
				//1번 컨텐츠
				secSold1=oRange.Cells(k,22);//솔드아웃,판매예정
				if(secSold1=='.' || secSold1.value == undefined || secSold1.value == null || secSold1.value == false || secSold1.value == 'NULL'){secSold1='';}
				if(secSold1=="soldout"){secSold1='<div class="soldout"><span class="soldout_txt">SOLD OUT</span><p class="soldout_back"></p></div>'}
				else{secSold1='';}
				secSNme1=oRange.Cells(k,13);//설명글
				if(secSNme1=='.' || secSNme1.value == undefined || secSNme1.value == null || secSNme1.value == false){secSNme1='';}
				else{secSNme1='	<dd class="txt">'+secSNme1+'</dd>';};
				...
				if(secico11=='ico01'){
					icon1 = icon1 +
									'		<div class="'+secico11+'"><span>무료배송</span></div>'+
									'';
				}
				else if(secico11=='ico02'){
					icon1 = icon1 +
									'		<div class="'+secico11+'"><span>신상품</span></div>'+
									'';
				}
				else if(secico11=='ico03'){
					icon1 = icon1 +
									'		<div class="'+secico11+'"><span>쿠폰</span></div>'+
									'';
				}
				else if(secico11=='ico04'){
					icon1 = icon1 +
									'		<div class="'+secico11+'"><span>사은품</span></div>'+
									'';
				}
				else if(secico11=='ico05'){
					icon1 = icon1 +
									'		<div class="'+secico11+'"><span>이벤트</span></div>'+
									'';
				}
				else if(secico11=='ico06'){
					icon1 = icon1 +
									'		<div class="'+secico11+'"><span>BEST</span></div>'+
									'';
				}
				else if(secico11=='ico07'){
					icon1 = icon1 +
									'		<div class="'+secico11+'"><span>최저가</span></div>'+
									'';
				}
				else{};
				secico12=oRange.Cells(k,26);//아이콘2
				if(secico12=='ico01'){
					icon1 = icon1 +
									'		<div class="'+secico12+'"><span>무료배송</span></div>'+
									'';
				}
				else if(secico12=='ico02'){
					icon1 = icon1 +
									'		<div class="'+secico12+'"><span>신상품</span></div>'+
									'';
				}
				else if(secico12=='ico03'){
					icon1 = icon1 +
									'		<div class="'+secico12+'"><span>쿠폰</span></div>'+
									'';
				}
				else if(secico12=='ico04'){
					icon1 = icon1 +
									'		<div class="'+secico12+'"><span>사은품</span></div>'+
									'';
				}
				else if(secico12=='ico05'){
					icon1 = icon1 +
									'		<div class="'+secico12+'"><span>이벤트</span></div>'+
									'';
				}
				else if(secico12=='ico06'){
					icon1 = icon1 +
									'		<div class="'+secico12+'"><span>BEST</span></div>'+
									'';
				}
				else if(secico12=='ico07'){
					icon1 = icon1 +
									'		<div class="'+secico12+'"><span>최저가</span></div>'+
									'';
				}
				else{};
				...
				if(secico13=='ico01'){
					icon1 = icon1 +
									'		<div class="'+secico13+'"><span>무료배송</span></div>'+
									'';
				}
				else if(secico13=='ico02'){
					icon1 = icon1 +
									'		<div class="'+secico13+'"><span>신상품</span></div>'+
									'';
				}
				else if(secico13=='ico03'){
					icon1 = icon1 +
									'		<div class="'+secico13+'"><span>쿠폰</span></div>'+
									'';
				}
				else if(secico13=='ico04'){
					icon1 = icon1 +
									'		<div class="'+secico13+'"><span>사은품</span></div>'+
									'';
				}
				else if(secico13=='ico05'){
					icon1 = icon1 +
									'		<div class="'+secico13+'"><span>이벤트</span></div>'+
									'';
				}
				else if(secico13=='ico06'){
					icon1 = icon1 +
									'		<div class="'+secico13+'"><span>BEST</span></div>'+
									'';
				}
				else if(secico13=='ico07'){
					icon1 = icon1 +
									'		<div class="'+secico13+'"><span>최저가</span></div>'+
									'';
				}
				else{};
				secCpn1=oRange.Cells(k,29);//쿠폰율
				...
				allCode = allCode+'<!-- // 가이드 영역 시작 부분 입니다.  -->'+
									'<div class="'+oRange.Cells(k,3)+'">'+
										'<div class="n1">'+
											'<dl>'+
											secSold1+
											'	<dt class="pic"><img src="'+secPic1+'" onerror="this.src=\'http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/common/error.jpg\';" alt=""/></dt>'+
											'	<dd class="icoD">'+
											icon1+
											'	</dd>'+
											secSNme1+
											'	<dd class="ttl"><span>'+secBrd1+'</span>'+secNme1+'</dd>'+
											'	<dd class="priceInfo"><strong class="sale">'+secDct11+'<span>%</span></strong><p class="price"><s>'+secPri1+'</s><strong>'+secDPri1+'</strong></p></dd>'+
											'	<dd class="lnk"><a href="'+secLnk1+'">링크</a></dd>'+
											'</dl>'+
										'</div>'+
									 '</div>';
			...
			/* n2 */
				...
				secSold2=oRange.Cells(k,22);//솔드아웃,판매예정
				if(secSold2=='.' || secSold2.value == undefined || secSold2.value == null || secSold2.value == false || secSold2.value == 'NULL'){secSold2='';}
				if(secSold2=="soldout"){secSold2='<div class="soldout"><span class="soldout_txt">SOLD OUT</span><p class="soldout_back"></p></div>'}
				else{secSold2='';}
				secSNme2=oRange.Cells(k,13);//설명글
				if(secSNme2=='.' || secSNme2.value == undefined || secSNme2.value == null || secSNme2.value == false){secSNme2='';}
				else{secSNme2='	<dd class="txt">'+secSNme2+'</dd>';};
				...
				if(secico21=='ico01'){
					icon2 = icon2 +
									'		<div class="'+secico21+'"><span>무료배송</span></div>'+
									'';
				}
				else if(secico21=='ico02'){
					icon2 = icon2 +
									'		<div class="'+secico21+'"><span>신상품</span></div>'+
									'';
				}
				else if(secico21=='ico03'){
					icon2 = icon2 +
									'		<div class="'+secico21+'"><span>쿠폰</span></div>'+
									'';
				}
				else if(secico21=='ico04'){
					icon2 = icon2 +
									'		<div class="'+secico21+'"><span>사은품</span></div>'+
									'';
				}
				else if(secico21=='ico05'){
					icon2 = icon2 +
									'		<div class="'+secico21+'"><span>이벤트</span></div>'+
									'';
				}
				else if(secico21=='ico06'){
					icon2 = icon2 +
									'		<div class="'+secico21+'"><span>BEST</span></div>'+
									'';
				}
				else if(secico21=='ico07'){
					icon2 = icon2 +
									'		<div class="'+secico21+'"><span>최저가</span></div>'+
									'';
				}
				else{};
				secico22=oRange.Cells(k,26);//아이콘2
				if(secico22=='ico01'){
					icon2 = icon2 +
									'		<div class="'+secico22+'"><span>무료배송</span></div>'+
									'';
				}
				else if(secico22=='ico02'){
					icon2 = icon2 +
									'		<div class="'+secico22+'"><span>신상품</span></div>'+
									'';
				}
				else if(secico22=='ico03'){
					icon2 = icon2 +
									'		<div class="'+secico22+'"><span>쿠폰</span></div>'+
									'';
				}
				else if(secico22=='ico04'){
					icon2 = icon2 +
									'		<div class="'+secico22+'"><span>사은품</span></div>'+
									'';
				}
				else if(secico22=='ico05'){
					icon2 = icon2 +
									'		<div class="'+secico22+'"><span>이벤트</span></div>'+
									'';
				}
				else if(secico22=='ico06'){
					icon2 = icon2 +
									'		<div class="'+secico22+'"><span>BEST</span></div>'+
									'';
				}
				else if(secico22=='ico07'){
					icon2 = icon2 +
									'		<div class="'+secico22+'"><span>최저가</span></div>'+
									'';
				}
				else{};
				...
				if(secico23=='ico01'){
					icon2 = icon2 +
									'		<div class="'+secico23+'"><span>무료배송</span></div>'+
									'';
				}
				else if(secico23=='ico02'){
					icon2 = icon2 +
									'		<div class="'+secico23+'"><span>신상품</span></div>'+
									'';
				}
				else if(secico23=='ico03'){
					icon2 = icon2 +
									'		<div class="'+secico23+'"><span>쿠폰</span></div>'+
									'';
				}
				else if(secico23=='ico04'){
					icon2 = icon2 +
									'		<div class="'+secico23+'"><span>사은품</span></div>'+
									'';
				}
				else if(secico23=='ico05'){
					icon2 = icon2 +
									'		<div class="'+secico23+'"><span>이벤트</span></div>'+
									'';
				}
				else if(secico23=='ico06'){
					icon2 = icon2 +
									'		<div class="'+secico23+'"><span>BEST</span></div>'+
									'';
				}
				else if(secico23=='ico07'){
					icon2 = icon2 +
									'		<div class="'+secico23+'"><span>최저가</span></div>'+
									'';
				}
				else{};
				secCpn2=oRange.Cells(k,29);//쿠폰율
				...
				allCode = allCode+'<!-- // 가이드 영역 시작 부분 입니다.  -->'+
									'<div class="'+oRange.Cells(k,3)+'">'+
										'<div class="n2">'+
											...
											'<dl>'+
											secSold2+
											'	<dt class="pic"><img src="'+secPic2+'" onerror="this.src=\'http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/common/error.jpg\';" alt=""/></dt>'+
											secSNme2+
											'	<dd class="ttl"><span>'+secBrd2+'</span>'+secNme2+'</dd>'+
											'	<dd class="priceInfo"><strong class="sale">'+secDct21+'<span>%</span></strong><p class="price"><s>'+secPri2+'</s><strong>'+secDPri2+'</strong></p></dd>'+
											'	<dd class="icoD">'+
											icon2+
											'	</dd>'+
											'	<dd class="lnk"><a href="'+secLnk2+'">링크</a></dd>'+
			...
			/* n3 */
				...
				//3번 컨텐츠
				secSold3=oRange.Cells(k,22);//솔드아웃,판매예정
				if(secSold3=='.' || secSold3.value == undefined || secSold3.value == null || secSold3.value == false || secSold3.value == 'NULL'){secSold3='';}
				if(secSold3=="soldout"){secSold3='<div class="soldout"><span class="soldout_txt">SOLD OUT</span><p class="soldout_back"></p></div>'}
				else{secSold3='';}
				secNme3=oRange.Cells(k,11);//타이틀명
				secBrd3=oRange.Cells(k,12);//브랜드
				 if(secBrd3=='.' || secBrd3.value == undefined || secBrd3.value == null || secBrd3.value == false || secBrd3.value == 'NULL'){secBrd3='';}
				...
				if(secico31=='ico01'){
					icon3 = icon3 +
									'		<div class="'+secico31+'"><span>무료배송</span></div>'+
									'';
				}
				else if(secico31=='ico02'){
					icon3 = icon3 +
									'		<div class="'+secico31+'"><span>신상품</span></div>'+
									'';
				}
				else if(secico31=='ico03'){
					icon3 = icon3 +
									'		<div class="'+secico31+'"><span>쿠폰</span></div>'+
									'';
				}
				else if(secico31=='ico04'){
					icon3 = icon3 +
									'		<div class="'+secico31+'"><span>사은품</span></div>'+
									'';
				}
				else if(secico31=='ico05'){
					icon3 = icon3 +
									'		<div class="'+secico31+'"><span>이벤트</span></div>'+
									'';
				}
				else if(secico31=='ico06'){
					icon3 = icon3 +
									'		<div class="'+secico31+'"><span>BEST</span></div>'+
									'';
				}
				else if(secico31=='ico07'){
					icon3 = icon3 +
									'		<div class="'+secico31+'"><span>최저가</span></div>'+
									'';
				}
				else{};
				secico32=oRange.Cells(k,26);//아이콘2
				if(secico32=='ico01'){
					icon3 = icon3 +
									'		<div class="'+secico32+'"><span>무료배송</span></div>'+
									'';
				}
				else if(secico32=='ico02'){
					icon3 = icon3 +
									'		<div class="'+secico32+'"><span>신상품</span></div>'+
									'';
				}
				else if(secico32=='ico03'){
					icon3 = icon3 +
									'		<div class="'+secico32+'"><span>쿠폰</span></div>'+
									'';
				}
				else if(secico32=='ico04'){
					icon3 = icon3 +
									'		<div class="'+secico32+'"><span>사은품</span></div>'+
									'';
				}
				else if(secico32=='ico05'){
					icon3 = icon3 +
									'		<div class="'+secico32+'"><span>이벤트</span></div>'+
									'';
				}
				else if(secico32=='ico06'){
					icon3 = icon3 +
									'		<div class="'+secico32+'"><span>BEST</span></div>'+
									'';
				}
				else if(secico32=='ico07'){
					icon3 = icon3 +
									'		<div class="'+secico32+'"><span>최저가</span></div>'+
									'';
				}
				else{};
				...
				if(secico33=='ico01'){
					icon3 = icon3 +
									'		<div class="'+secico33+'"><span>무료배송</span></div>'+
									'';
				}
				else if(secico33=='ico02'){
					icon3 = icon3 +
									'		<div class="'+secico33+'"><span>신상품</span></div>'+
									'';
				}
				else if(secico33=='ico03'){
					icon3 = icon3 +
									'		<div class="'+secico33+'"><span>쿠폰</span></div>'+
									'';
				}
				else if(secico33=='ico04'){
					icon3 = icon3 +
									'		<div class="'+secico33+'"><span>사은품</span></div>'+
									'';
				}
				else if(secico33=='ico05'){
					icon3 = icon3 +
									'		<div class="'+secico33+'"><span>이벤트</span></div>'+
									'';
				}
				else if(secico33=='ico06'){
					icon3 = icon3 +
									'		<div class="'+secico33+'"><span>BEST</span></div>'+
									'';
				}
				else if(secico33=='ico07'){
					icon3 = icon3 +
									'		<div class="'+secico33+'"><span>최저가</span></div>'+
									'';
				}
				else{};
				secCpn3=oRange.Cells(k,29);//쿠폰율
				...
				allCode = allCode+'<!-- // 가이드 영역 시작 부분 입니다.  -->'+
									'<div class="'+oRange.Cells(k,3)+'">'+
										'<div class="n3">'+
											...
											'<dl>'+
											secSold3+
											'	<dt class="pic"><img src="'+secPic3+'" onerror="this.src=\'http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/common/error.jpg\';" alt=""/></dt>'+
											'	<dd class="ttl"><span>'+secBrd3+'</span>'+secNme3+'</dd>'+
											'	<dd class="priceInfo"><strong class="sale">'+secDct31+'<span>%</span></strong><p class="price"><s>'+secPri3+'</s><strong>'+secDPri3+'</strong></p></dd>'+
											'	<dd class="icoD">'+
											icon3+
											'	</dd>'+
											'	<dd class="lnk"><a href="'+secLnk3+'">링크</a></dd>'+
			...
			/* n4 */
				...
				//4번 컨텐츠
				secSold4=oRange.Cells(k,22);//솔드아웃,판매예정
				if(secSold4=='.' || secSold4.value == undefined || secSold4.value == null || secSold4.value == false || secSold4.value == 'NULL'){secSold4='';}
				if(secSold4=="soldout"){secSold4='<div class="soldout"><span class="soldout_txt">SOLD OUT</span><p class="soldout_back"></p></div>'}
				else{secSold4='';}
				secNme4=oRange.Cells(k,11);//타이틀명
				secBrd4=oRange.Cells(k,12);//브랜드
				 if(secBrd4=='.' || secBrd4.value == undefined || secBrd4.value == null || secBrd4.value == false || secBrd4.value == 'NULL'){secBrd4='';}
				...
				if(secico41=='ico01'){
					icon4 = icon4 +
									'		<div class="'+secico41+'"><span>무료배송</span></div>'+
									'';
				}
				else if(secico41=='ico02'){
					icon4 = icon4 +
									'		<div class="'+secico41+'"><span>신상품</span></div>'+
									'';
				}
				else if(secico41=='ico03'){
					icon4 = icon4 +
									'		<div class="'+secico41+'"><span>쿠폰</span></div>'+
									'';
				}
				else if(secico41=='ico04'){
					icon4 = icon4 +
									'		<div class="'+secico41+'"><span>사은품</span></div>'+
									'';
				}
				else if(secico41=='ico05'){
					icon4 = icon4 +
									'		<div class="'+secico41+'"><span>이벤트</span></div>'+
									'';
				}
				else if(secico41=='ico06'){
					icon4 = icon4 +
									'		<div class="'+secico41+'"><span>BEST</span></div>'+
									'';
				}
				else if(secico41=='ico07'){
					icon4 = icon4 +
									'		<div class="'+secico41+'"><span>최저가</span></div>'+
									'';
				}
				else{};
				secico42=oRange.Cells(k,26);//아이콘2
				if(secico42=='ico01'){
					icon4 = icon4 +
									'		<div class="'+secico42+'"><span>무료배송</span></div>'+
									'';
				}
				else if(secico42=='ico02'){
					icon4 = icon4 +
									'		<div class="'+secico42+'"><span>신상품</span></div>'+
									'';
				}
				else if(secico42=='ico03'){
					icon4 = icon4 +
									'		<div class="'+secico42+'"><span>쿠폰</span></div>'+
									'';
				}
				else if(secico42=='ico04'){
					icon4 = icon4 +
									'		<div class="'+secico42+'"><span>사은품</span></div>'+
									'';
				}
				else if(secico42=='ico05'){
					icon4 = icon4 +
									'		<div class="'+secico42+'"><span>이벤트</span></div>'+
									'';
				}
				else if(secico42=='ico06'){
					icon4 = icon4 +
									'		<div class="'+secico42+'"><span>BEST</span></div>'+
									'';
				}
				else if(secico42=='ico07'){
					icon4 = icon4 +
									'		<div class="'+secico42+'"><span>최저가</span></div>'+
									'';
				}
				else{};
				...
				if(secico43=='ico01'){
					icon4 = icon4 +
									'		<div class="'+secico43+'"><span>무료배송</span></div>'+
									'';
				}
				else if(secico43=='ico02'){
					icon4 = icon4 +
									'		<div class="'+secico43+'"><span>신상품</span></div>'+
									'';
				}
				else if(secico43=='ico03'){
					icon4 = icon4 +
									'		<div class="'+secico43+'"><span>쿠폰</span></div>'+
									'';
				}
				else if(secico43=='ico04'){
					icon4 = icon4 +
									'		<div class="'+secico43+'"><span>사은품</span></div>'+
									'';
				}
				else if(secico43=='ico05'){
					icon4 = icon4 +
									'		<div class="'+secico43+'"><span>이벤트</span></div>'+
									'';
				}
				else if(secico43=='ico06'){
					icon4 = icon4 +
									'		<div class="'+secico43+'"><span>BEST</span></div>'+
									'';
				}
				else if(secico43=='ico07'){
					icon4 = icon4 +
									'		<div class="'+secico43+'"><span>최저가</span></div>'+
									'';
				}
				else{};
				secCpn4=oRange.Cells(k,29);//쿠폰율
				...
				allCode = allCode+'<!-- // 가이드 영역 시작 부분 입니다.  -->'+
									'<div class="'+oRange.Cells(k,3)+'">'+
										'<div class="n4">'+
											...
											'<dl>'+
											secSold4+
											'	<dt class="pic"><img src="'+secPic4+'" onerror="this.src=\'http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/common/error.jpg\';" alt=""/></dt>'+
											'	<dd class="ttl"><span>'+secBrd4+'</span>'+secNme4+'</dd>'+
											'	<dd class="priceInfo"><strong class="sale">'+secDct41+'<span>%</span></strong><p class="price"><s>'+secPri4+'</s><strong>'+secDPri4+'</strong></p></dd>'+
											'	<dd class="icoD">'+
											icon4+
											'	</dd>'+
											'	<dd class="lnk"><a href="'+secLnk4+'">링크</a></dd>'+
			...
			/* n5 */
				...
				secSold5=oRange.Cells(k,22);//솔드아웃,판매예정
				if(secSold5=='.' || secSold5.value == undefined || secSold5.value == null || secSold5.value == false || secSold5.value == 'NULL'){secSold5='';}
				if(secSold5=="soldout"){secSold5='<div class="soldout"><span class="soldout_txt">SOLD OUT</span><p class="soldout_back"></p></div>'}
				else{secSold5='';}
				secNme5=oRange.Cells(k,11);//타이틀명
				secBrd5=oRange.Cells(k,12);//브랜드
				 if(secBrd5=='.' || secBrd5.value == undefined || secBrd5.value == null || secBrd5.value == false || secBrd5.value == 'NULL'){secBrd5='';}
				...
				if(secico51=='ico01'){
					icon5 = icon5 +
									'		<div class="'+secico51+'"><span>무료배송</span></div>'+
									'';
				}
				else if(secico51=='ico02'){
					icon5 = icon5 +
									'		<div class="'+secico51+'"><span>신상품</span></div>'+
									'';
				}
				else if(secico51=='ico03'){
					icon5 = icon5 +
									'		<div class="'+secico51+'"><span>쿠폰</span></div>'+
									'';
				}
				else if(secico51=='ico04'){
					icon5 = icon5 +
									'		<div class="'+secico51+'"><span>사은품</span></div>'+
									'';
				}
				else if(secico51=='ico05'){
					icon5 = icon5 +
									'		<div class="'+secico51+'"><span>이벤트</span></div>'+
									'';
				}
				else if(secico51=='ico06'){
					icon5 = icon5 +
									'		<div class="'+secico51+'"><span>BEST</span></div>'+
									'';
				}
				else if(secico51=='ico07'){
					icon5 = icon5 +
									'		<div class="'+secico51+'"><span>최저가</span></div>'+
									'';
				}
				else{};
				secico52=oRange.Cells(k,26);//아이콘2
				if(secico52=='ico01'){
					icon5 = icon5 +
									'		<div class="'+secico52+'"><span>무료배송</span></div>'+
									'';
				}
				else if(secico52=='ico02'){
					icon5 = icon5 +
									'		<div class="'+secico52+'"><span>신상품</span></div>'+
									'';
				}
				else if(secico52=='ico03'){
					icon5 = icon5 +
									'		<div class="'+secico52+'"><span>쿠폰</span></div>'+
									'';
				}
				else if(secico52=='ico04'){
					icon5 = icon5 +
									'		<div class="'+secico52+'"><span>사은품</span></div>'+
									'';
				}
				else if(secico52=='ico05'){
					icon5 = icon5 +
									'		<div class="'+secico52+'"><span>이벤트</span></div>'+
									'';
				}
				else if(secico52=='ico06'){
					icon5 = icon5 +
									'		<div class="'+secico52+'"><span>BEST</span></div>'+
									'';
				}
				else if(secico52=='ico07'){
					icon5 = icon5 +
									'		<div class="'+secico52+'"><span>최저가</span></div>'+
									'';
				}
				else{};
				...
				if(secico53=='ico01'){
					icon5 = icon5 +
									'		<div class="'+secico53+'"><span>무료배송</span></div>'+
									'';
				}
				else if(secico53=='ico02'){
					icon5 = icon5 +
									'		<div class="'+secico53+'"><span>신상품</span></div>'+
									'';
				}
				else if(secico53=='ico03'){
					icon5 = icon5 +
									'		<div class="'+secico53+'"><span>쿠폰</span></div>'+
									'';
				}
				else if(secico53=='ico04'){
					icon5 = icon5 +
									'		<div class="'+secico53+'"><span>사은품</span></div>'+
									'';
				}
				else if(secico53=='ico05'){
					icon5 = icon5 +
									'		<div class="'+secico53+'"><span>이벤트</span></div>'+
									'';
				}
				else if(secico53=='ico06'){
					icon5 = icon5 +
									'		<div class="'+secico53+'"><span>BEST</span></div>'+
									'';
				}
				else if(secico53=='ico07'){
					icon5 = icon5 +
									'		<div class="'+secico53+'"><span>최저가</span></div>'+
									'';
				}
				else{};
				secCpn5=oRange.Cells(k,29);//쿠폰율
				...
				allCode = allCode+'<!-- // 가이드 영역 시작 부분 입니다.  -->'+
									'<div class="'+oRange.Cells(k,3)+'">'+
										'<div class="n5">'+
											...
											'<dl>'+
											secSold5+
											'	<dt class="pic"><img src="'+secPic5+'" onerror="this.src=\'http://mall.hyundailivart.co.kr/UserFiles/Image/01_promotion/common/error.jpg\';" alt=""/></dt>'+
											'	<dd class="ttl"><span>'+secBrd5+'</span>'+secNme5+'</dd>'+
											'	<dd class="priceInfo"><strong class="sale">'+secDct51+'<span>%</span></strong><p class="price"><s>'+secPri5+'</s><strong>'+secDPri5+'</strong></p></dd>'+
											'	<dd class="icoD">'+
											icon5+
											'	</dd>'+
											'	<dd class="lnk"><a href="'+secLnk5+'">링크</a></dd>'+
